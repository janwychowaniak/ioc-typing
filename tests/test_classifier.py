...
class TestDomainClassification:
    def test_valid_domains(self, classifier):
        ...
        for domain in valid_domains:
            ...
            assert result["determined"] is True, f"Failed to classify valid domain: {domain}"
            assert result["type_pri"] == "domain", f"Wrong classification for domain: {domain}"
...
class TestURLClassification:
    ...
    def test_complex_url_structures(self, classifier):
        complex_urls = [
            ...
            "https://user:password@www.example.com:443/path/to/resource?param1=value1&param2=value2#section",
...
class TestHashClassification:
    ...
    def test_invalid_hashes(self, classifier):
        invalid_hashes = [
            ...
            "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b85",     # Too short SHA256
            "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b8555",   # Too long SHA256
